    ...
    <div className="py-16 bg-gradient-to-b from-background to-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">Master Subscription Agreement</h1>
          <h2 className="text-2xl font-semibold text-text-secondary">Terms & Conditions</h2>
        </div>
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="prose prose-lg max-w-none text-text-secondary space-y-8">
            ...
            <p className="mb-6">
              This Master Subscription Agreement (this "Agreement") contains terms and conditions that govern your purchase of subscriptions to, and use of, the Services (as defined in Section 2 below), and is a contract between our company and you or the entity or organization that you represent.
            </p>

            <p className="mb-6">
              This platform (Hereinafter Referred to as "Platform," "Mobile Application") is a Website & Mobile Based Client Communication integration platform owned and operated by our company (Hereinafter referred to as "we," "us," or "our").
            </p>
            ...
            <p className="mb-6">
              This document is an electronic record in terms of the Information Technology Act, 2000, Digital Personal Data Protection Act, 2023 and the General Data Protection Regulation (GDPR) (EU). and rules framed thereunder, as applicable, and the amended provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000, Digital Personal Data Protection Act, 2023 and the General Data Protection Regulation (GDPR) (EU). This electronic record is generated by a computer system and does not require any physical or digital signatures.
            </p>
            ...
            <p className="mb-6">
              We have no control over the pricing decisions made by Meta Platforms, Inc. We reserve the right to change the conversation charges if Meta changes its pricing, and we will not be held liable for refunds of Subscription charges or damages in such cases.
            </p>

            <p className="mb-6">
              Hence, we suggest users kindly understand the conversation pricing carefully, as mentioned on our website, and subscribe to the plan only after thoroughly comprehending the conversation costs. It is essential to clearly understand the conversation cost before subscribing to our plan.
            </p>

            <h3 className="text-xl font-semibold text-text-primary mb-3">Subscription of Plan:</h3>
            <p className="mb-6">
              To avail Services, the user will signup and choose an appropriate plan from the subscription plans available from time to time and shall agree to pay the applicable fee as mentioned in the chosen subscription plan ("Subscription Fee"). The Subscription Fee shall be paid by You on a monthly/quarterly/half-yearly/annual basis, within seven (7) days from the invoice date. Your subscription to Services will renew automatically unless the account is terminated. Payment obligations are non-cancelable, regardless of utilization by You, and except as expressly permitted in this Terms of Use, Subscription Fee paid are non-refundable.
            </p>
            ...
            <h2 className="text-2xl font-semibold text-text-primary mb-4">Cancellation & Refund</h2>
            <p className="mb-6">
              All monthly, quarterly, yearly, and multi-year subscriptions renew automatically on their due renewal date according to the date of purchase until officially cancelled in writing. Customers may cancel anytime by emailing a notice to support@wotzapmsg.com
            </p>

            <p className="mb-6">
              <strong>Important:</strong> No refunds or credits for partial months or years of service will be refunded to a customer upon cancellation.
            </p>
            ...
            <h2 className="text-2xl font-semibold text-text-primary mb-4">Intellectual Property Rights</h2>
            <p className="mb-6">
            ...
            <p className="mb-6">
              The trademarks and product names visible on this Platform are either trademarks or registered trademarks owned by our company. Except as explicitly stipulated in these Terms of Use or with Our written authorization, You are prohibited from using any of our Marks or Intellectual Property, either individually or in combination with other words or design elements. This includes their use in press releases, advertisements, promotional materials, or any form of media.
            </p>
            ...
            <h2 className="text-2xl font-semibold text-text-primary mb-4">Representations and Warranties</h2>
            <p className="mb-4">You represent and warrant that:</p>
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li>You possess full capability and competence to engage in this Terms of Use and possess the entitlement, authorization, and capacity to participate in and be bound by this Terms of Use. Furthermore, you commit to adhere to the stipulated terms and conditions presented herein.</li>
              <li>You agree not to exceed the intended functionality of the Services.</li>
              <li>You shall refrain from trying to access the Services, networks, servers, or computer systems linked to the Services without proper authorization.</li>
              <li>Usage of the Services in a manner that could cause damage or impairment to (i) the Services themselves, or (ii) the foundational systems and security measures, is prohibited.</li>
              <li>Engaging with the Services in an unlawful fashion or in a way that supports or encourages illegal activities, such as copyright infringement or data theft, is against the terms.</li>
              <li>Without our explicit consent, you will not exploit any intellectual property, whether owned by us or third parties. This includes refraining from using copyrighted content displayed on the Platform for personal or third-party gain.</li>
              <li>Modification, adaptation, translation, or reverse engineering of any segment of the Services, like creating a mimic site or Website that closely resembles said Services, is not allowed.</li>
              <li>You commit to promptly informing us in case your Mobile Contact Number is listed in the Do Not Disturb/National Consumer Preference Register List of the Telecom Regulatory Authority of India ("TRAI"), following the Primary Registration.</li>
              <li>You acknowledge that any calls or text messages received from us on your Mobile Contact Number are not unsolicited.</li>
              <li>You will avoid taking actions or refraining from actions that could result in liability for us or the loss (partially or entirely) of services from our Internet service providers (ISPs) or other partners, suppliers, contractors, vendors.</li>
            </ul>
            ...
            <h2 className="text-2xl font-semibold text-text-primary mb-4">Force Majeure</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-semibold text-text-primary mb-4">General</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li>All notifications must be provided to Us via email, or for all communications to be considered valid, You must provide notifications to Us via email, or to You at the email or postal address you provided.</li>
              <li>In order for any waiver to be considered valid regarding Our rights or remedies under these Terms of Use, it must satisfy the following conditions: it must be in written form, executed by Our duly authorized representative, and pertain solely to the specific circumstances for which it is granted. The failure on Our part to exercise or enforce any right or remedy under these Terms of Use shall not be interpreted as a waiver of said right or remedy, nor shall it impede any future exercise or enforcement of the same. The utilization of any right or remedy, either in its entirety or in part, shall not impose limitations or constraints on the subsequent exercise of that right, remedy, or any other rights or remedies.</li>
              <li>These Terms of Use and Our Privacy Policies referenced herein constitute the entire agreement between the parties regarding the subject matter.</li>
              <li>The headings used in these Terms of Use are for convenience only and have no legal or contractual effect. The terms "including" and "includes" mean "including without limitation."</li>
              <li>The provisions stated in these Terms of Use are intended to be interpreted in concordance with one another and in compliance with applicable laws, including those specific to the User's jurisdiction, to the fullest extent allowed by law. Furthermore, each provision within these Terms of Use is independently enforceable, and the invalidity of any other provisions shall not influence the validity of one provision. If any provision within these Terms of Use is found to be invalid or unenforceable for any reason, the remaining provisions will remain unaffected to the greatest extent permissible under the applicable laws. Should a provision be considered void but capable of being valid with certain parts removed, it shall be applied with necessary modifications to ensure its validity.</li>
              <li>By confirming, You assert that no employment, contractor, agency, or partnership association exists between You and Us. We are exclusively delivering the Services based on Your request. Additionally, You affirm that You are either acting on Your own behalf or representing another individual, as outlined in these Terms of Use.</li>
              <li>These Terms of Use, along with any dispute or claim arising from or connected with them (including non-contractual disputes or claims), shall be governed by and interpreted in accordance with the laws of India. You hereby consent to the exclusive jurisdiction of the courts located in Mumbai, Maharashtra, for the resolution of any dispute or claim arising from or related to these Terms of Use.</li>
            </ul>
    </section>
            <section className="border-b border-gray-100 pb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4 flex items-center">
              ...
              <p className="mb-6">
                If you have any questions or suggestions about our Terms and Conditions, do not hesitate to contact us at support@wotzapmsg.com
              </p>
            </section>
          </div>
          <div className="text-center mt-8">
            <p className="text-sm text-gray-600">For any questions about these terms, contact us at <a href="mailto:support@wotzapmsg.com" className="text-primary underline">support@wotzapmsg.com</a> or <a href="tel:9316360039" className="text-primary underline">9316360039</a>.</p>
          </div>
        </div>
      </div>
    </div>
