  ...
  const contactMethods = [
    {
      ...
      icon: 'ShoppingCart',
      details: [
        { label: 'Email', value: 'zanand1828@gmail.com', icon: 'Mail' },
        { label: 'Email', value: 'support@wotzapmsg.com', icon: 'Mail' },
        { label: 'Phone', value: '9316360039', icon: 'Phone' },
                ...
                {method.details.map((detail, detailIndex) => (
                  <div key={detailIndex} className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {detail.label === 'Email' ? (
                        <a href={`mailto:${detail.value}`} className="text-sm text-gray-600 underline">{detail.value}</a>
                      ) : (
