      ...
      <header className={`sticky top-0 z-100 transition-all duration-300 ${isScrolled
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            {/* Logo */}
            <Link to="/home-page" className="flex items-center h-20 min-w-0">
              <img
                src="/assets/images/wotzap-logo.png"
                alt="Wotzap Digital Solution S Logo"
                className="h-30 w-auto max-w-[16rem] mx-auto object-contain"
              />
            </Link>
